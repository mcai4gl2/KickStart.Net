...
{
    [TestFixture]
    public class InMemoryConfigurationManagerTests
    {
        ...
        public void SetUp()
        {
            _configurationManager = new InMemoryConfigurationManager(new Dictionary<string, string>
            {
                {"TestKeyString", "TestValue"},
                {"TestKeyBool", "true"},
                {"TestKeyBoolNonParsable", "test"},
                {"TestKeyInt", "500"},
            });
        }
        ...
        {
            Assert.AreEqual("InMemory", _configurationManager.Name);
        }
