...
namespace KickStart.Net.Tests.Metrics
{
    ...
    public class UniformSnapshotTests
    {
        ...
        public void SetUp()
        {
            _snapshot = new UniformSnapshot(5, 1, 2, 3, 4);
        }
        ...
        {
            Assert.AreEqual(4.5, _snapshot.Get75thPercentile());
        }
        ...
        [Test]
        public void test_construct_from_enumerable()
        {
            Assert.AreEqual(_snapshot.GetValues(), new UniformSnapshot(new List<long> {5L, 1L, 2L, 3L, 4L}).GetValues());
        }
        ...
        {
            Assert.AreEqual(3, _snapshot.GetMean());
        }

        [Test]
        public void test_std_dev()
        {
            Assert.AreEqual(1.5811, _snapshot.GetStdDev(), 0.0001);
        }
